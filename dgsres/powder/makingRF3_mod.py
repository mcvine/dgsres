...
class ModelFitting():
    ...
    def param(self):
        ...
        for i in range(no_Et_Files):
            ...
            # if i>0:
            #     mod.set_param_hint('R', value=R_cal, vary=True)
            #     mod.set_param_hint('a', value=a_cal,vary=True)
            #     mod.set_param_hint('b', value=b_cal,vary=True)
            #     mod.set_param_hint('s', value=s_fixed, min=0.0)
            #     mod.set_param_hint('t0', value=t0_cal, min=0.0, vary=True)
